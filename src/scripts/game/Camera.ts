...
//
// The perfect-hit camera micro-response is a shared zoom pulse applied at
// render time (rendering/Renderer.ts), not a positional nudge here — one
// effect, not two competing ones (PLAN.md §11/§15).
